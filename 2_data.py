...
from vcd_extract.workflows.workflow_utils import copy_folder
from data_analysis.data_process import DataProcess
...
def main():
    ...
    data_storage_path = f"{root_path}/data_storage/{design_name}"
