...
from data_analysis.utils.process import raw_data_to_rough_data, rough_data_to_summarized_data, rough_data_to_embedding_data
from data_analysis.utils.process import get_max_length, get_mean_length, get_median_length
from data_analysis.utils.package import package_data
from vcd_extract.workflows.workflow_utils import copy_folder, combine_ranges
...
class DataProcess:
    ...
    def process_raw_data(self):
        ...
        self.raw_folders_list = [
            f for f in self.raw_folders_list if f not in self.ignore_files_list]
    ...
    def process_rough_data(self):
        ...
        for folder in self.raw_folders_list:
            ...
            #                  )
            # single thread
            # rough_data_to_embedding_data(
            #     self.rough_data_path,
            #     self.processed_uncompressed_data_path,
            #     folder,
            #     self.before_failure_timeframe,
            #     self.pad_value
            # )
            pool.apply_async(rough_data_to_embedding_data,
                             args=(
                                 self.rough_data_path,
                                 self.processed_uncompressed_data_path,
                                 folder,
    ...
    def package_data(self):
        package_data(self.processed_uncompressed_data_path,
