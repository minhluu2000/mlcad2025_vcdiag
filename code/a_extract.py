...
from a_bug_injection_vcd_extract.workflows.fabscalar import FabScalar
from a_bug_injection_vcd_extract.workflows.mesi import MESI
from a_bug_injection_vcd_extract.workflows.opentitan import OpenTitan

from a_bug_injection_vcd_extract.workflows.workflow_utils import clean_design_env
...
def main():
    ...
    bugdb_path = f"{root_path}/a_bug_injection_vcd_extract/bugdb/{design_name}"
    target_signals_path = f"{root_path}/a_bug_injection_vcd_extract/signals/{design_name}/target_signals.txt"
