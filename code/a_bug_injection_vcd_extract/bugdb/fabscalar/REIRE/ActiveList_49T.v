...
*/
  ...
  wire                                                   fuEn1;
  wire [                           `WRITEBACK_FLAGS-1:0] fuData1; // BUG_11: Inserted missing_assignment bug
  wire [                       `SIZE_ACTIVELIST_LOG-1:0] fuAddr2; // BUG_15: Inserted wrong_assignment bug
  wire                                                   fuEn2;
  wire [                           `WRITEBACK_FLAGS-1:0] fuData2; // BUG_12: Inserted wrong_assignment bug
 ...
 */
  ...
  */
  ...
  assign mispredictBit1_f = ~ctrlAl1[0]; // BUG_13: Inserted bitwise_corruption bug
...
`ifdef VERIFY
    commitVerify0 = 0;
    commitVerify1 = 1; // BUG_14: Inserted logic_bug bug
    commitVerify2 = 0;
    commitVerify3 = 0;
