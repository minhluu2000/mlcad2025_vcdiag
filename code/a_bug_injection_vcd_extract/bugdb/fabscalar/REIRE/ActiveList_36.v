...
*/
  ...
  wire                                                   ctrlMispredict; // BUG_15: Inserted logic_bug bug
  wire                                                   ctrlMispredict_f;
  wire [                       `SIZE_ACTIVELIST_LOG-1:0] mispredictEntry;

  reg  [                         `SIZE_ACTIVELIST_LOG:0] activeListCount_f;
  reg  [                       `SIZE_ACTIVELIST_LOG-1:0] newheadAL; // BUG_13: Inserted bitwise_corruption bug
 ...
 */
  ...
  */
  always @(*) begin : GENERATE_COUNT
    ...
    tailAL_f          = (backEndReady_i) ? (tailAL | `DISPATCH_WIDTH) : tailAL; // BUG_14: Inserted bitwise_corruption bug
