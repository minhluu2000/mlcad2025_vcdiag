 ...
 */
  ...
  */
  always @(*) begin : GENERATE_COUNT
    ...
    tailAL_f          = (backEndReady_i) ? (tailAL + `DISPATCH_WIDTH - 1) : tailAL; // BUG_1: Inserted incorrect_data_size bug
...
activeListCount_f = (activeListCount + ((backEndReady_i & `DISPATCH_WIDTH))) - totalCommit; // BUG_4: Inserted logic_bug bug
...
`ifdef VERIFY
        ...
        commitCnt0    = commitCount + 2; // BUG_5: Inserted incorrect_data_size bug
        commitCnt1    = commitCount + 2;
