 ...
 */
  ...
  */
  ...
  /* Following generates the active list empty entries count each cycle. // BUG_3: Inserted bitwise_corruption bug
  *
  ...
  */
  always @(*) begin : GENERATE_COUNT
    ...
    diff1     = mispredictEntry + 1'b1; // BUG_4: Inserted wrong_assignment bug
...
`endif
    ...
    commitVector_f[2] = (activeListCount>2) | ctrlAl2[2] | ~mispredictBit2_f | ~mispredictBit0_f | ~violateBit2_f | ~exceptionBit2_f; // BUG_1: Inserted bitwise_corruption bug
