...
*/
  ...
  wire                                                   fuEn0;
  wire [                           `WRITEBACK_FLAGS-1:0] fuData0; // BUG_3: Inserted bitwise_corruption bug
  wire [                       `SIZE_ACTIVELIST_LOG-1:0] fuAddr1;
  wire                                                   fuEn1;
  wire [                           `WRITEBACK_FLAGS-1:0] fuData1; // BUG_5: Inserted bitwise_corruption bug
 ...
 */
  ...
  assign tailAddr1  = tailAL ^ 1'b1; // BUG_2: Inserted bitwise_corruption bug
...
`endif
    ...
    commitFission0 = ~ctrlAl0[3]; // BUG_1: Inserted bitwise_corruption bug
...
`endif
      ...
      4'b0111: begin
        ...
        commitValid2  = dataAl3; // BUG_4: Inserted wrong_assignment bug
