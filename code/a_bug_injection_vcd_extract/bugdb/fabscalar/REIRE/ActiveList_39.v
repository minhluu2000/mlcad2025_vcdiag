...
*/
  ...
  wire fuEn1; // BUG_5: Inserted bitwise_corruption bug
  ...
  reg  [                       `SIZE_ACTIVELIST_LOG-1:0] newheadAL; // BUG_1: Inserted bitwise_corruption bug
 ...
 */
  ...
  */
  ...
  always @(*) begin : COMMIT
    ...
    commitValid0   = 0;
    // commitPacket0  = 0; // BUG_4: Inserted missing_assignment bug
    commitStore0   = 0;
    commitLoad0    = 0;
    commitFission0 = 0;
    commitValid1   = 0;
...
`ifdef VERIFY
  always @(posedge clk) begin : CLEAR_CTRL_AL
    ...
    if (reset) begin
      ...
      // commitCount <= commitCount_f; // BUG_2: Inserted missing_assignment bug
    end
