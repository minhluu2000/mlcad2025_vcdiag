...
*/
  ...
  wire [                       `SIZE_ACTIVELIST_LOG-1:0] fuAddr1; // BUG_12: Inserted bitwise_corruption bug
  wire                                                   fuEn1;
 ...
 */
  ...
  */
  always @(*) begin : GENERATE_COUNT
    ...
    tailAL_f          = (backEndReady_i) ? (tailAL + `DISPATCH_WIDTH) : (tailAL + 1); // BUG_11: Inserted wrong_assignment bug
...
`endif
      ...
      4'b1111: begin
        ...
        commitValid3  = dataAl2[0]; // BUG_14: Inserted wrong_assignment bug
