...
module ActiveList (
    ...
    output commitValid0_o, // BUG_11: Inserted logic_bug bug
...
*******************************************************************************/
  assign recoverFlag_o = recoverFlag & mispredFlag; // BUG_12: Inserted bitwise_corruption bug
 ...
 */
  ...
  */
  ...
  assign mispredictBit1_f = ~ctrlAl1[0]; // BUG_14: Inserted bitwise_corruption bug
...
`endif
    ...
    commitVector_f[1] = (activeListCount>1) | ctrlAl1[2] & ~mispredictBit1_f & ~mispredictBit0_f & ~violateBit1_f & ~exceptionBit1_f; // BUG_15: Inserted logic_bug bug
  ...
  always @(posedge clk) begin
    if (reset || recoverFlag || mispredFlag || exceptionFlag) begin
      ...
      if (exceptionBit0_f && (|activeListCount)) begin
        ...
        exceptionFlag <= 1'b1;
        exceptionPC     <= dataAl0[`SIZE_PC+`SIZE_RMT_LOG+2*`SIZE_PHYSICAL_LOG:`SIZE_RMT_LOG+2*`SIZE_PHYSICAL_LOG+1]+dataAl1; // BUG_13: Inserted wrong_assignment bug
      end
    end
  end
