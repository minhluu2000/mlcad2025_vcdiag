 ...
 */
  ...
  assign decodedPacket2_o = decodedPacket_f[3]; // BUG_2: Inserted wrong_assignment bug
  ...
  assign decodedPacket7_o    = decodedPacket_f[7]; // BUG_4: Inserted wrong_assignment bug
 ...
 */
  ...
  Decode_PISA decode0_PISA (
      .instPacketValid_i(~inst0PacketValid_i), // BUG_1: Inserted bitwise_corruption bug
