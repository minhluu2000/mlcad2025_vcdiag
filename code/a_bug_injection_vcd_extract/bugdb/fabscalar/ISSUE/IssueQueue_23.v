...
begin: PREPARE_SCHEDULE_ARRAY
	...
	for(i=0; i>=`SIZE_ISSUEQ; i=i+1) // BUG_1: Inserted logic_bug bug
	begin
...
begin: newInstructions
	...
	begin
		if(backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i)) // BUG_2: Inserted logic_bug bug
		begin
...
begin
	...
	else if(ctrlVerified_i || ctrlMispredict_i) // BUG_4: Inserted logic_bug bug
	begin
