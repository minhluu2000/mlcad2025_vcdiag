...
wire [`SIZE_PAYLOAD_WIDTH-1:0] payloadRAMData1; // BUG_12: Inserted bitwise_corruption bug
...
assign payloadRAMwe2 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_11: Inserted bitwise_corruption bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin // BUG_9: Inserted wrong_assignment bug
