...
assign CAM0we0 = backEndReady_i && (ctrlVerified_i & ctrlMispredict_i); // BUG_8: Inserted bitwise_corruption bug
...
assign CAM1we3 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_6: Inserted bitwise_corruption bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.we0_i(CAM1we0),
	.we1_i(CAM1we1),
	.we2_i(CAM2we2), // BUG_7: Inserted wrong_assignment bug
	.we3_i(CAM1we3),
