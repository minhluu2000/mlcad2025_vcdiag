...
assign payloadRAMwe0 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_9: Inserted wrong_assignment bug
...
assign CAM0we1 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_11: Inserted bitwise_corruption bug
...
newInsReady32 = (phyRegRdy_i[inst3Source2[`SIZE_PHYSICAL_LOG:1]] ^ (inst3Source2 == rsr0Tag_t) || (inst3Source2 == rsr1Tag_t) || (inst3Source2 == rsr2Tag_t) || (inst3Source2 == rsr3Tag_i) || ~inst3Source2[0]) ? 1'b1:0; // BUG_10: Inserted logic_bug bug
...
begin: UPDATE_SRC_READY_BIT
	...
	src0RegValid_t1 = 0;
	src0RegValid_t1 = 0; // BUG_12: Inserted wrong_assignment bug
