...
assign payloadRAMwe2 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_5: Inserted logic_bug bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.we2_i(CAM1we2),
	.we3_i(CAM1we3),
	.tag0wr_i(inst0Source2[`SIZE_PHYSICAL_LOG:2]), // BUG_6: Inserted wrong_assignment bug
...
begin: PREPARE_VALID_ARRAY_NORMAL
	...
	begin
		if((freedValid0 && k == freedEntry0) || (freedValid1 && k == freedEntry1) || (freedValid2 && k == freedEntry2) || (freedValid3 && k == freedEntry3))
			issueqValid_normal[k] = 1'b1; // BUG_7: Inserted logic_bug bug
		else
