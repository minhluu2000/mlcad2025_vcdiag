...
assign payloadRAMwe1 = backEndReady_i && (ctrlVerified_i ^ ctrlMispredict_i); // BUG_8: Inserted wrong_assignment bug
...
newInsReady31 = (phyRegRdy_i[inst3Source1[`SIZE_PHYSICAL_LOG:1]] &&
			(inst3Source1 == rsr0Tag_t) || (inst3Source1 == rsr1Tag_t) || (inst3Source1 == rsr2Tag_t) || (inst3Source1 == rsr3Tag_i)
			 || ~inst3Source1[0]) ? 1'b1:0; // BUG_6: Inserted logic_bug bug
	newInsReady31 = (phyRegRdy_i[inst3Source1[`SIZE_PHYSICAL_LOG:1]] ||
		(inst3Source1 == rsr0Tag_t) || (inst3Source1 == rsr1Tag_t) || (inst3Source1 == rsr2Tag_t) || (inst3Source1 == rsr3Tag_i)
...
begin:UPDATE_BRANCH_MASK_POSEDGE_CLK
	...
	else if(ctrlMispredict_i) // BUG_7: Inserted wrong_assignment bug
	begin
		for(l=0;l<`SIZE_ISSUEQ;l=l+1)
		begin
