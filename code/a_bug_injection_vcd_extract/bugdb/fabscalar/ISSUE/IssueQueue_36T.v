...
assign grantedPacket0_t = {BRANCH_MASK[grantedEntry0], grantedEntry0, payloadRAMData0};
  assign grantedPacket1_t = {BRANCH_MASK[grantedEntry0], grantedEntry0, payloadRAMData0};
  assign grantedPacket2_t = {BRANCH_MASK[grantedEntry0], grantedEntry0, payloadRAMData0};
  assign grantedPacket3_t = {BRANCH_MASK[grantedEntry0], grantedEntry0, payloadRAMData0};
