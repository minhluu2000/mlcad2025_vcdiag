...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	newInsReady01 = (phyRegRdy_i[inst0Source1[`SIZE_PHYSICAL_LOG:1]] ||
		(inst0Source1 == rsr0Tag_t) && (inst0Source1 == rsr1Tag_t) && (inst0Source1 == rsr2Tag_t) && (inst0Source1 == rsr3Tag_i) // BUG_1: Inserted logic_bug bug
...
Select select1(.clk(clk),
	...
	.grantedEntry_o(grantedEntry2), // BUG_3: Inserted wrong_assignment bug
...
RSR2 rsr(
	...
	.validPacket1_i(grantedValid2_t), // BUG_4: Inserted wrong_assignment bug
