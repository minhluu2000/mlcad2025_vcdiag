...
************************************************************************************/
assign payloadRAMwe0 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_2: Inserted logic_bug bug
assign payloadRAMwe2 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_1: Inserted wrong_assignment bug
...
begin: newInstructions
	...
	begin
		if(backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i)) // BUG_3: Inserted logic_bug bug
		begin
