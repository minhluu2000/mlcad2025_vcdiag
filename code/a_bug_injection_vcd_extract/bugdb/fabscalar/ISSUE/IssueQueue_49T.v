...
wire [`SIZE_PAYLOAD_WIDTH-1:0] payloadRAMDataWr1; // BUG_1: Inserted wrong_assignment bug
...
assign CAM1we3 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_3: Inserted missing_assignment bug
