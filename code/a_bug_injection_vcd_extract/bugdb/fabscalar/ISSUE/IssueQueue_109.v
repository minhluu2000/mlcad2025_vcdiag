...
wire [`SIZE_ISSUEQ-1:0] src0_matchLines0; // BUG_7: Inserted bitwise_corruption bug
...
assign rsr1Tag_t = {rsr0Tag, rsr0TagValid}; // BUG_8: Inserted wrong_assignment bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	inst3Source1 = dispatchPacket3_i[2*`SIZE_PHYSICAL_LOG+2+`SIZE_IMMEDIATE+1+`LDST_TYPES_LOG+ // BUG_6: Inserted wrong_assignment bug
		`INST_TYPES_LOG+`SIZE_OPCODE_I+2*`SIZE_PC+`SIZE_CTI_LOG:`SIZE_PHYSICAL_LOG+1+
		`SIZE_IMMEDIATE+1+`LDST_TYPES_LOG+`INST_TYPES_LOG+`SIZE_OPCODE_I+2*`SIZE_PC+
		`SIZE_CTI_LOG+1];
