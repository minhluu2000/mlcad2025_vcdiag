...
assign CAM0we0 = backEndReady_i || (ctrlVerified_i || ctrlMispredict_i); // BUG_15: Inserted bitwise_corruption bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	...
	newInsReady21 = (phyRegRdy_i[inst2Source1[`SIZE_PHYSICAL_LOG:1]] && // BUG_16: Inserted logic_bug bug
...
begin: preparing_request_vector_for_FU0
	...
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
		requestVector0[k] = (ISSUEQ_VALID[k] | ~ISSUEQ_SCHEDULED[k] | SRC0_REG_VALID[k] | SRC1_REG_VALID[k] | (ISSUEQ_FU[k] == 2'b00)) ? 1'b1:1'b0; // BUG_13: Inserted bitwise_corruption bug
	end
end
...
begin: preparing_request_vector_for_FU1
	...
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
		requestVector1[k] = (ISSUEQ_VALID[k] | ~ISSUEQ_SCHEDULED[k] | SRC0_REG_VALID[k] | SRC1_REG_VALID[k] | (ISSUEQ_FU[k] == 2'b01)) ? 1'b1:1'b0; // BUG_14: Inserted bitwise_corruption bug
	end
end
