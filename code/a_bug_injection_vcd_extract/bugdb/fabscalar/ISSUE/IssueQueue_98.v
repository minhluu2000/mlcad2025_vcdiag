...
************************************************************************************/
assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_7: Inserted wrong_assignment bug
assign payloadRAMwe1 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_6: Inserted bitwise_corruption bug
...
IssueQFreeList issueQfreelist(.clk(clk),
	...
	// .mispredictVector_i(freedValid_mispre), // BUG_4: Inserted missing_assignment bug
