...
assign payloadRAMDataWr3 = {inst3Source2[`SIZE_PHYSICAL_LOG:1],inst3Source1[`SIZE_PHYSICAL_LOG:1],
	...
	`SIZE_IMMEDIATE+1+`LDST_TYPES_LOG+`INST_TYPES_LOG+`SIZE_OPCODE_I+
	// 2*`SIZE_PC+`SIZE_CTI_LOG:4*`SIZE_PHYSICAL_LOG+4+`SIZE_IMMEDIATE+1+ // BUG_3: Inserted missing_assignment bug
	`LDST_TYPES_LOG+`INST_TYPES_LOG+`SIZE_OPCODE_I+2*`SIZE_PC+`SIZE_CTI_LOG+1],
...
assign CAM0we3 = backEndReady_i && (ctrlVerified_i || ctrlMispredict_i); // BUG_4: Inserted bitwise_corruption bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	...
	newInsReady32 = (phyRegRdy_i[inst3Source2[`SIZE_PHYSICAL_LOG:1]] && // BUG_1: Inserted logic_bug bug
...
always @(*)
begin: preparing_request_vector_for_FU2 // BUG_2: Inserted missing_assignment bug
	integer k;
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
