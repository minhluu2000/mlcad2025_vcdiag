...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.tag1wr_i(inst1Source2[`SIZE_PHYSICAL_LOG - 1:1]), // BUG_4: Inserted incorrect_data_size bug
...
begin: PREPARE_SCHEDULE_ARRAY
	...
	for(i=0; i<`SIZE_ISSUEQ; i=i+1)
	begin
		if(backEndReady_i || ((i == freeEntry0) || (i == freeEntry1) || (i == freeEntry2) || (i == freeEntry3))) // BUG_2: Inserted logic_bug bug
