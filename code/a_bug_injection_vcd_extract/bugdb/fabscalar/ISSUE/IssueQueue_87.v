...
************************************************************************************/
assign payloadRAMwe0 = backEndReady_i ^ ~(ctrlVerified_i && ctrlMispredict_i); // BUG_5: Inserted bitwise_corruption bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	...
	newInsReady32 = (phyRegRdy_i[inst3Source2[`SIZE_PHYSICAL_LOG:1]] & // BUG_8: Inserted bitwise_corruption bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin
			...
			// src1RegValid_t1[j]  =  newInsReady02; // BUG_6: Inserted missing_assignment bug
		end
