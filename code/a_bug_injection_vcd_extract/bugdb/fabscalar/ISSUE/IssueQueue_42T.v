...
assign payloadRAMDataWr3 = {inst3Source1[`SIZE_PHYSICAL_LOG:1], inst3Source2[`SIZE_PHYSICAL_LOG:1], // BUG_4: Inserted wrong_assignment bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.we1_i(CAM1we1),
	.we2_i(CAM1we2),
	.we3_i(CAM2we3), // BUG_3: Inserted wrong_assignment bug
...
begin: PREPARE_SCHEDULE_ARRAY
	...
	begin
		if(backEndReady_i && ((i == freeEntry0) || (i == freeEntry1) || (i == freeEntry2) || (i == freeEntry3)))
			...
			issueqSchedule_tmp[i] = ~ISSUEQ_SCHEDULED[i]; // BUG_1: Inserted bitwise_corruption bug
	end
