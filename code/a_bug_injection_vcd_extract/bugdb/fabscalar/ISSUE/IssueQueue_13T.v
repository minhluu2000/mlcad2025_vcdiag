...
CAM_4R4W #(`SIZE_ISSUEQ, `SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src0cam (
      .clk(clk),
      .reset(reset),
      .tag3_i(rsr0Tag_t[`SIZE_PHYSICAL_LOG:1]),
      .tag2_i(rsr1Tag_t[`SIZE_PHYSICAL_LOG:1]),
      .tag1_i(rsr2Tag_t[`SIZE_PHYSICAL_LOG:1]),
      .tag0_i(rsr3Tag_i[`SIZE_PHYSICAL_LOG:1]),
      .addr0wr_i(freeEntry3),
      .addr1wr_i(freeEntry2),
      .addr2wr_i(freeEntry1),
      .addr3wr_i(freeEntry0),
      .we0_i(CAM0we0),
      .we1_i(CAM0we1),
      .we2_i(CAM0we2),
      .we3_i(CAM0we3),
      ...
      .match0_o(src0_matchLines3),
      .match1_o(src0_matchLines2),
      .match2_o(src0_matchLines1),
      .match3_o(src0_matchLines0)
  );//bug issue 13
