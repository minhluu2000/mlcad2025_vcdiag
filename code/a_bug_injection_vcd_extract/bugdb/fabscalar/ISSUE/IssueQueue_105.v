...
/* Wires for Issue Queue Payload RAM */ // BUG_4: Inserted missing_assignment bug
...
assign payloadRAMwe2 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_3: Inserted logic_bug bug
...
begin: PREPARE_VALID_ARRAY_MISPRED
	...
	for(i=0; i<=`SIZE_ISSUEQ; i=i+1) // BUG_2: Inserted logic_bug bug
	begin
...
begin
	...
	begin
		...
		begin
			// ISSUEQ_VALID <= issueqValid_mispre; // BUG_1: Inserted missing_assignment bug
		end
		else
		begin
