...
wire [`SIZE_PAYLOAD_WIDTH-1:0] payloadRAMDataWr3; // BUG_3: Inserted missing_assignment bug
...
************************************************************************************/
assign payloadRAMwe0 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_4: Inserted logic_bug bug
assign payloadRAMwe2 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_2: Inserted wrong_assignment bug
