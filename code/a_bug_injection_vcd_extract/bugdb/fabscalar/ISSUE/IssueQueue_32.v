...
begin: PREPARE_VALID_ARRAY_NORMAL
	...
	begin
		if((freedValid0 && k == freedEntry0) || (freedValid1 && k == freedEntry1) || (freedValid2 && k == freedEntry2) || (freedValid3 && k == freedEntry3))
			issueqValid_normal[k] = 1'b1; // BUG_1: Inserted logic_bug bug
		else
...
begin:UPDATE_BRANCH_MASK_POSEDGE_CLK
	...
	begin
		...
		begin
			...
			else if(backEndReady_i || (l == freeEntry1)) // BUG_3: Inserted logic_bug bug
			begin
...
Select select2(.clk(clk),
	.reset(reset),
	.requestVector_i(requestVector1), // BUG_2: Inserted wrong_assignment bug
