...
assign CAM0we2 = backEndReady_i && ~(ctrlVerified_i || ctrlMispredict_i); // BUG_13: Inserted bitwise_corruption bug
assign CAM0we3 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i);

assign CAM1we0 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_15: Inserted missing_assignment bug
assign CAM1we1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i);
assign CAM1we2 = backEndReady_i & (ctrlVerified_i && ctrlMispredict_i); // BUG_16: Inserted missing_assignment bug
