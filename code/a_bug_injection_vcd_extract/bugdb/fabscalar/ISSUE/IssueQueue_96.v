...
wire [`SIZE_PAYLOAD_WIDTH-1:0] payloadRAMData1; // BUG_9: Inserted missing_assignment bug
...
************************************************************************************/
// assign payloadRAMwe0 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_10: Inserted missing_assignment bug
assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i);
assign payloadRAMwe2 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_12: Inserted bitwise_corruption bug
...
begin: PREPARE_VALID_ARRAY_MISPRED
	...
	for(i=0; i<`SIZE_ISSUEQ; i=i+1)
	begin
		if(ctrlVerified_i || ctrlMispredict_i)    /* Unnecessary logic? */ // BUG_11: Inserted logic_bug bug
		begin
