...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src0cam (.clk(clk),
	...
	.addr2wr_i(freeEntry2),
	.addr3wr_i(freeEntry3),
	.we0_i(~CAM0we0), // BUG_2: Inserted bitwise_corruption bug
	.we1_i(CAM0we1),
	.we2_i(CAM0we2),
	.we3_i(CAM0we3),
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin
			// src0RegValid_t1[j]  =  newInsReady01; // BUG_4: Inserted missing_assignment bug
 ...
 * *************************/
	...
	assign granted0Dest  = grantedPacket1_t[`SIZE_PHYSICAL_LOG+`SIZE_IMMEDIATE+`LDST_TYPES_LOG+ // BUG_3: Inserted wrong_assignment bug
