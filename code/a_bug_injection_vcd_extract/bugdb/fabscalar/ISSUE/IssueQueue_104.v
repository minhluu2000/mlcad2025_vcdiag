...
assign payloadRAMwe2 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_7: Inserted bitwise_corruption bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin
			src1RegValid_t1[j]  =  newInsReady11; // BUG_5: Inserted wrong_assignment bug
...
* [i] New Entry position should be set to 0 // BUG_4: Inserted logic_bug bug
