...
begin: PREPARE_VALID_ARRAY_MISPRED
	...
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin // BUG_7: Inserted wrong_assignment bug
		if((freedValid0 && k == freedEntry0) || (freedValid1 && k == freedEntry1) || (freedValid2 && k == freedEntry2) || (freedValid3 && k == freedEntry3))
...
RSR2 rsr(
	...
	.validPacket2_i(grantedValid1_t), // BUG_6: Inserted wrong_assignment bug
	...
	.branchMask2_i(~BRANCH_MASK[grantedEntry2]), // BUG_5: Inserted bitwise_corruption bug
