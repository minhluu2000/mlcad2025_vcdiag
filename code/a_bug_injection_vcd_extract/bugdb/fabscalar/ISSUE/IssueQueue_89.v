...
assign payloadRAMwe2 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_8: Inserted wrong_assignment bug
...
newInsReady31 = (phyRegRdy_i[inst3Source1[`SIZE_PHYSICAL_LOG:1]] ||
		(inst3Source1 == rsr0Tag_t) || (inst3Source1 == rsr1Tag_t) || (inst3Source1 == rsr2Tag_t) || (inst3Source1 == rsr3Tag_i)
		 || ~inst3Source1[0]) ? 1'b1:0; // BUG_6: Inserted wrong_assignment bug
	newInsReady31 = (phyRegRdy_i[inst3Source1[`SIZE_PHYSICAL_LOG:1]] ||
		(inst3Source1 == rsr0Tag_t) || (inst3Source1 == rsr1Tag_t) || (inst3Source1 == rsr2Tag_t) || (inst3Source1 == rsr3Tag_i)
