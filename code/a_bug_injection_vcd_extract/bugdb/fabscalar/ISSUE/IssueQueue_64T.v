...
begin: preparing_request_vector_for_FU1
	integer k;
	// for(k=0; k<`SIZE_ISSUEQ; k=k+1) // BUG_1: Inserted missing_assignment bug
	begin
		// requestVector1[k] = (ISSUEQ_VALID[k] & ~ISSUEQ_SCHEDULED[k] & SRC0_REG_VALID[k] & SRC1_REG_VALID[k] & (ISSUEQ_FU[k] == 2'b01)) ? 1'b1:1'b0; // BUG_3: Inserted missing_assignment bug
	end
end
