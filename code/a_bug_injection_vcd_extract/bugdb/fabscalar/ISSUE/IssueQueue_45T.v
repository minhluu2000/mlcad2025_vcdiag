...
assign CAM1we0 = backEndReady_i && (ctrlVerified_i || ctrlMispredict_i); // BUG_3: Inserted bitwise_corruption bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.we0_i(CAM1we0),
	.we1_i(CAM1we1),
	.we2_i(~CAM1we2), // BUG_4: Inserted logic_bug bug
	.we3_i(NEW_CAM1we3), // BUG_2: Inserted wrong_assignment bug
