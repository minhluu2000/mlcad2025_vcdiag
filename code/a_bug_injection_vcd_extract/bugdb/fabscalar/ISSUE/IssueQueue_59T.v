...
assign CAM0we0 = backEndReady_i && (ctrlVerified_i ^ ctrlMispredict_i); // BUG_3: Inserted bitwise_corruption bug
...
Select select2(.clk(clk),
	.reset(reset),
	.requestVector_i(~requestVector2), // BUG_4: Inserted bitwise_corruption bug
