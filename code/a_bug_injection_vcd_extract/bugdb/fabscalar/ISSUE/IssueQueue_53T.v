...
assign payloadRAMDataWr1 = {inst1Source1[`SIZE_PHYSICAL_LOG:1],inst1Source1[`SIZE_PHYSICAL_LOG:1], // BUG_5: Inserted wrong_assignment bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk), // BUG_7: Inserted bitwise_corruption bug
	.reset(reset),
	...
	.we0_i(CAM1we0),
	.we1_i(CAM1we1),
	.we2_i(CAM1we1), // BUG_8: Inserted wrong_assignment bug
	.we3_i(CAM1we3),
