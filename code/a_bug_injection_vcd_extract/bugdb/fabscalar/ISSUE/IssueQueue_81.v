...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	newInsReady01 = (phyRegRdy_i[inst0Source1[`SIZE_PHYSICAL_LOG:1]] ^ // BUG_7: Inserted logic_bug bug
		(inst0Source1 != rsr0Tag_t) || (inst0Source1 == rsr1Tag_t) || (inst0Source1 == rsr2Tag_t) || (inst0Source1 == rsr3Tag_i) // BUG_5: Inserted bitwise_corruption bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin
			// src0RegValid_t1[j]  =  newInsReady11; // BUG_6: Inserted missing_assignment bug
