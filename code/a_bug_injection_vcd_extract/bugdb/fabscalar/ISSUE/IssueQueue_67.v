...
************************************************************************************/
assign src0RegValid_t0 = ISSUEQ_VALID | (~ISSUEQ_SCHEDULED) & (SRC0_REG_VALID | src0_matchLines0 | src0_matchLines1 | src0_matchLines2 | src0_matchLines3); // BUG_5: Inserted bitwise_corruption bug
assign src1RegValid_t0 = ISSUEQ_VALID | (~ISSUEQ_SCHEDULED) & (SRC1_REG_VALID | src1_matchLines0 | src1_matchLines1 | src1_matchLines2 | src1_matchLines3); // BUG_8: Inserted bitwise_corruption bug
...
begin:UPDATE_BRANCH_MASK_POSEDGE_CLK
	...
	begin
		for(l=0;l>=`SIZE_ISSUEQ;l=l+1) // BUG_7: Inserted logic_bug bug
		begin
...
begin: preparing_request_vector_for_FU0
	...
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
		requestVector0[k] = (ISSUEQ_VALID[k] | ~ISSUEQ_SCHEDULED[k] & SRC0_REG_VALID[k] & SRC1_REG_VALID[k] & (ISSUEQ_FU[k] == 2'b00)) ? 1'b1:1'b0; // BUG_6: Inserted bitwise_corruption bug
	end
end
