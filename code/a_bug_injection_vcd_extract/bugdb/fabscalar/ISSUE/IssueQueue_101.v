...
assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_11: Inserted wrong_assignment bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	newInsReady01 = (phyRegRdy_i[inst0Source1[`SIZE_PHYSICAL_LOG:1]] && // BUG_9: Inserted logic_bug bug
		(inst0Source1 ^ rsr0Tag_t) || (inst0Source1 ^ rsr1Tag_t) || (inst0Source1 ^ rsr2Tag_t) || (inst0Source1 ^ rsr3Tag_i) // BUG_10: Inserted bitwise_corruption bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin
			...
			src0RegValid_t1[j]  =  newInsReady02; // BUG_12: Inserted wrong_assignment bug
		end
