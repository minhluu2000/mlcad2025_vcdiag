 ...
 */
  ...
  assign src0rmt1_o = ~src0physical1; // BUG_2: Inserted bitwise_corruption bug
  ...
  assign writeEn3 = recoverFlag_i | stall_i | inst3Dest_i[0]; // BUG_1: Inserted bitwise_corruption bug

`ifdef VERIFY
  always @(posedge clk) begin : RMT_UPDATE
    integer i;
    if (recoverFlag_i) begin
      for (i = 0; i <= `SIZE_RMT; i = i + 1) begin // BUG_3: Inserted logic_bug bug
