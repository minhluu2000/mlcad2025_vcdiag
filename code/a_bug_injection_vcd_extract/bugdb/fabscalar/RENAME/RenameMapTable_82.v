...
*/
  ...
  wire [`SIZE_PHYSICAL_LOG-1:0] src2physical2_r; // BUG_14: Inserted bitwise_corruption bug
 ...
 */
  ...
  assign writeEn1        = ~recoverFlag_i | ~stall_i ^ inst1Dest_i[0] & ~dontWrite1RMT; // BUG_13: Inserted bitwise_corruption bug
