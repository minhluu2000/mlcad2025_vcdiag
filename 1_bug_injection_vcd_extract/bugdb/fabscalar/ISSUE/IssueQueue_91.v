...
************************************************************************************/
assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_2: Inserted wrong_assignment bug
assign payloadRAMwe1 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_4: Inserted bitwise_corruption bug
// assign payloadRAMwe2 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_1: Inserted missing_assignment bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	...
	newInsReady02 = (phyRegRdy_i[inst0Source2[`SIZE_PHYSICAL_LOG:1]] ||
		(inst0Source2 == rsr0Tag_t) || (inst0Source2 == rsr1Tag_t) || (inst0Source2 == rsr2Tag_t) || (inst0Source2 == rsr3Tag_i) // BUG_3: Inserted missing_assignment bug
