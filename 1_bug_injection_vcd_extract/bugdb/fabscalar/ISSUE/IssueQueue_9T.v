...
************************************************************************************/
assign src0RegValid_t0 = ISSUEQ_VALID & (ISSUEQ_SCHEDULED) & (SRC1_REG_VALID | src0_matchLines0 | src0_matchLines1 | src0_matchLines2 | src0_matchLines3);
  assign src1RegValid_t0 = ISSUEQ_VALID & (ISSUEQ_SCHEDULED) & (SRC0_REG_VALID | src1_matchLines0 | src1_matchLines1 | src1_matchLines2 | src1_matchLines3);
//bug issue 9
