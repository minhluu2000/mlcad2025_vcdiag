...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	...
	newInsReady11 = (phyRegRdy_i[inst1Source1[`SIZE_PHYSICAL_LOG:1]] && // BUG_8: Inserted logic_bug bug
...
Select select0(.clk(clk),
	...
	.grantedValid_o(grantedValid1) // BUG_7: Inserted wrong_assignment bug
);
...
RSR2 rsr(
	.clk(clk),
	.reset(!reset), // BUG_6: Inserted logic_bug bug
	.ctrlVerified_i(ctrlVerified_i),
	.ctrlMispredict_i(ctrlMispredict_i),
