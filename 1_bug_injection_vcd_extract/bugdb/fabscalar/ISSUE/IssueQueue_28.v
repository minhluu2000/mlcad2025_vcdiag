...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	newInsReady01 = (phyRegRdy_i[inst0Source1[`SIZE_PHYSICAL_LOG:1]] && // BUG_7: Inserted logic_bug bug
...
begin: PREPARE_VALID_ARRAY_NORMAL
	...
	begin
		if((freedValid0 && k == freedEntry0) || (freedValid1 && k == freedEntry1) || (freedValid2 && k == freedEntry2) || (freedValid3 && k == freedEntry3))
			issueqValid_normal[k] = 1'b1; // BUG_8: Inserted logic_bug bug
		else
...
begin: newInstructions
	...
	begin
		if(backEndReady_i && (ctrlVerified_i & ctrlMispredict_i)) // BUG_6: Inserted bitwise_corruption bug
		begin
...
RSR2 rsr(
	...
	.granted0Dest_i(granted1Dest), // BUG_5: Inserted wrong_assignment bug
