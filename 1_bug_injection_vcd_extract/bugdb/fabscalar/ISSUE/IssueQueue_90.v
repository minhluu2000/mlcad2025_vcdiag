...
************************************************************************************/
assign payloadRAMwe0 = backEndReady_i ^ ~(ctrlVerified_i && ctrlMispredict_i); // BUG_7: Inserted bitwise_corruption bug
assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i);
assign payloadRAMwe2 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_6: Inserted bitwise_corruption bug
...
begin: PREPARE_VALID_ARRAY_MISPRED
	...
	for(i=0; i<`SIZE_ISSUEQ; i=i+1) // BUG_5: Inserted missing_assignment bug
	begin
