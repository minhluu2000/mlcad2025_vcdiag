...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	...
	newInsReady12 = (phyRegRdy_i[inst1Source2[`SIZE_PHYSICAL_LOG:1]] && // BUG_2: Inserted logic_bug bug
...
begin: PREPARE_VALID_ARRAY_NORMAL
	...
	begin
		if(backEndReady_i && ((i == freeEntry0) || (i == freeEntry1) || (i == freeEntry2) || (i == freeEntry3)))
			...
			issueqValid_tmp[i] = ~ISSUEQ_VALID[i]; // BUG_1: Inserted bitwise_corruption bug
	end
...
begin
	...
	begin
		...
		begin
			// ISSUEQ_VALID <= issueqValid_normal; // BUG_4: Inserted missing_assignment bug
		end
