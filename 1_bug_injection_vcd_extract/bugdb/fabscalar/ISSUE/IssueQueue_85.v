...
// assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_4: Inserted missing_assignment bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		src1RegValid_t1[j]  =  src0RegValid_t0[j]; // BUG_3: Inserted wrong_assignment bug
		begin
