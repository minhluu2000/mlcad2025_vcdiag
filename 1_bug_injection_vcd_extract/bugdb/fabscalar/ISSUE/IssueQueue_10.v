...
assign CAM0we1 = backEndReady_i && (ctrlVerified_i & ctrlMispredict_i); // BUG_2: Inserted bitwise_corruption bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	...
	newInsReady12 = (phyRegRdy_i[inst1Source2[`SIZE_PHYSICAL_LOG:1]] && // BUG_4: Inserted logic_bug bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin
			src0RegValid_t1[j]  =  newInsReady02; // BUG_3: Inserted wrong_assignment bug
