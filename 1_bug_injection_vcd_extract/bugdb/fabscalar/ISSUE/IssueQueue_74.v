...
assign payloadRAMwe0 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_5: Inserted wrong_assignment bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin
			...
			// src1RegValid_t1[j]  =  newInsReady02; // BUG_8: Inserted missing_assignment bug
		end
