...
************************************************************************************/
assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_1: Inserted wrong_assignment bug
...
begin: UPDATE_BRANCH_MASK
	...
	for(k=0; k<`CHECKPOINTS; k=k+1) // BUG_3: Inserted logic_bug bug
	begin
