...
begin: preparing_request_vector_for_FU0
	integer k;
	// for(k=0; k<`SIZE_ISSUEQ; k=k+1) // BUG_4: Inserted missing_assignment bug
	begin
...
Select select0(.clk(clk),
	...
	.grantedValid_o(grantedValid1) // BUG_2: Inserted wrong_assignment bug
);
...
begin: preparing_request_vector_for_FU2
	integer k;
	// for(k=0; k<`SIZE_ISSUEQ; k=k+1) // BUG_3: Inserted missing_assignment bug
	begin
