...
// assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_10: Inserted missing_assignment bug
...
assign CAM1we0 = backEndReady_i && (ctrlVerified_i || ctrlMispredict_i); // BUG_11: Inserted bitwise_corruption bug
