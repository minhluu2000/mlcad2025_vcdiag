...
assign payloadRAMDataWr1 = {inst1Source1[`SIZE_PHYSICAL_LOG:1],inst1Source1[0], // BUG_4: Inserted wrong_assignment bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.we1_i(CAM1we1),
	.we2_i(CAM1we2),
	.we3_i(SOME_OTHER_VAR), // BUG_2: Inserted wrong_assignment bug
