...
wire payloadRAMwe0; // BUG_11: Inserted missing_assignment bug
wire payloadRAMwe1;
wire payloadRAMwe2;
wire payloadRAMwe3;
...
************************************************************************************/
// assign payloadRAMwe0 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_12: Inserted missing_assignment bug
assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i);
assign payloadRAMwe2 = backEndReady_i ^ ~(ctrlVerified_i && ctrlMispredict_i); // BUG_10: Inserted bitwise_corruption bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	 ...
	 * This is the common "If reading a location being written into this cycle, bypass the // BUG_9: Inserted missing_assignment bug
