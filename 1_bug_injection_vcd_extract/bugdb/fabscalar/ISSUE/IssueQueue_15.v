...
assign payloadRAMwe2 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_7: Inserted missing_assignment bug
...
assign CAM0we0 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_6: Inserted logic_bug bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.addr2wr_i(freeEntry2),
	.addr3wr_i(freeEntry3),
	.we0_i(CAM2we0), // BUG_8: Inserted wrong_assignment bug
	.we1_i(CAM1we1),
	.we2_i(CAM1we2),
	.we3_i(CAM1we3),
...
begin: preparing_request_vector_for_FU1
	...
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
		requestVector1[k] = (ISSUEQ_VALID[k] | ~ISSUEQ_SCHEDULED[k] & SRC0_REG_VALID[k] & SRC1_REG_VALID[k] & (ISSUEQ_FU[k] == 2'b01)) ? 1'b1:1'b0; // BUG_5: Inserted bitwise_corruption bug
	end
end
