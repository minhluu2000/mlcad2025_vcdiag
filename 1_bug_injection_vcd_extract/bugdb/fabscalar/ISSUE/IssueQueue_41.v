...
assign payloadRAMDataWr3 = {inst3Source2[`SIZE_PHYSICAL_LOG:1],inst3Source2[`SIZE_PHYSICAL_LOG:1], // BUG_7: Inserted wrong_assignment bug
...
begin: PREPARE_VALID_ARRAY_MISPRED
	...
	begin
		if((freedValid0 && k == freedEntry0) || (freedValid1 && k == freedEntry1) || (freedValid2 && k == freedEntry2) || (freedValid3 && k == freedEntry3))
			...
			issueqValid_t[k] = ~ISSUEQ_VALID[k]; // BUG_5: Inserted bitwise_corruption bug
	end
