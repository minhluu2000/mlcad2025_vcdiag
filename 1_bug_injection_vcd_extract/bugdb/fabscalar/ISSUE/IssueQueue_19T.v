...
assign grantedPacket3_t = {BRANCH_MASK[grantedEntry3], grantedEntry3, payloadRAMData3};
  ...
  assign grantedValid0_o = grantedValid3_t;
  assign grantedValid1_o = grantedValid2_t;
  assign grantedValid2_o = grantedValid1_t;
  assign grantedValid3_o = grantedValid0_t;//bug issue 19
