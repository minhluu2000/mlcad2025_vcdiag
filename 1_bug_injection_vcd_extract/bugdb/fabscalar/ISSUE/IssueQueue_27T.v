...
begin
    if (reset) begin
      SRC0_REG_VALID <= 0;
      SRC1_REG_VALID <= 0;
    end else if (ctrlVerified_i && ctrlMispredict_i) begin
      SRC0_REG_VALID <= src1RegValid_t0;
      SRC1_REG_VALID <= src0RegValid_t0;
    end else begin
      SRC0_REG_VALID <= src1RegValid_t1;
      SRC1_REG_VALID <= src0RegValid_t1;
    end //bug issue 27
end
