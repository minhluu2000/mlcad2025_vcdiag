...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		else if(backEndReady_i && (j == freeEntry1)) // BUG_3: Inserted wrong_assignment bug
		begin
...
begin: PREPARE_VALID_ARRAY_NORMAL
	...
	begin
		...
		else if(freedValid0 || freedValid1 || freedValid2 || freedValid3) // BUG_1: Inserted logic_bug bug
