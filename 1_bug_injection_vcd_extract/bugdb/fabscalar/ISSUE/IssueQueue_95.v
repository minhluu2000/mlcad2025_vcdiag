...
assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_4: Inserted wrong_assignment bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	newInsReady01 = (phyRegRdy_i[inst0Source1[`SIZE_PHYSICAL_LOG:1]] ||
		(inst0Source1 == rsr0Tag_t) ^ (inst0Source1 == rsr1Tag_t) || (inst0Source1 == rsr2Tag_t) || (inst0Source1 == rsr3Tag_i) // BUG_2: Inserted logic_bug bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		if(1'b1) begin // BUG_1: Inserted logic_bug bug
...
begin: PREPARE_VALID_ARRAY_MISPRED
	...
	begin
		...
		begin
			...
			else if (1'b0) // BUG_3: Inserted logic_bug bug
