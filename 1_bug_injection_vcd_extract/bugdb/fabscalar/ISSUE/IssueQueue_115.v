...
wire [`SIZE_PHYSICAL_LOG-1:0] granted0Dest; // BUG_5: Inserted missing_assignment bug
...
// assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_7: Inserted missing_assignment bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	...
	newInsReady11 = (phyRegRdy_i[inst1Source1[`SIZE_PHYSICAL_LOG:1]] && // BUG_8: Inserted bitwise_corruption bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin
			src1RegValid_t1[j]  =  newInsReady11; // BUG_6: Inserted wrong_assignment bug
