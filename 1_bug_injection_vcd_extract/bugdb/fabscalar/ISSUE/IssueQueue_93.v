...
assign payloadRAMwe2 = backEndReady_i ^ ~(ctrlVerified_i && ctrlMispredict_i); // BUG_1: Inserted bitwise_corruption bug
...
// assign CAM0we2 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_4: Inserted missing_assignment bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin
			// src0RegValid_t1[j]  =  newInsReady01; // BUG_2: Inserted missing_assignment bug
			src1RegValid_t1[j]  =  newInsReady02;
		end
		else if(backEndReady_i && (j == freeEntry2)) // BUG_3: Inserted wrong_assignment bug
		begin
