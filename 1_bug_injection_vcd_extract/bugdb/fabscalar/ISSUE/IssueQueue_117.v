...
assign payloadRAMwe1 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_12: Inserted bitwise_corruption bug
assign payloadRAMwe2 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_9: Inserted logic_bug bug
