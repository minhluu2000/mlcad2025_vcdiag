...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	...
	newInsReady32 = (phyRegRdy_i[inst3Source2[`SIZE_PHYSICAL_LOG:1]] ||
		(inst3Source2 != rsr0Tag_t) || (inst3Source2 == rsr1Tag_t) || (inst3Source2 == rsr2Tag_t) || (inst3Source2 == rsr3Tag_i) // BUG_2: Inserted logic_bug bug
...
begin: preparing_request_vector_for_FU0
	integer k; // BUG_3: Inserted missing_assignment bug
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
...
Select select0(.clk(clk),
	...
	.grantedEntry_o(grantedEntry1), // BUG_1: Inserted wrong_assignment bug
...
begin: preparing_request_vector_for_FU1
	integer k; // BUG_4: Inserted missing_assignment bug
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
