...
assign payloadRAMwe1 = backEndReady_i ^ ~(ctrlVerified_i && ctrlMispredict_i); // BUG_11: Inserted bitwise_corruption bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.addr2wr_i(freeEntry2),
	.addr3wr_i(freeEntry3),
	.we0_i(CAM1we1), // BUG_8: Inserted wrong_assignment bug
	.we1_i(CAM1we1),
	.we2_i(CAM1we2),
	.we3_i(CAM1we3),
