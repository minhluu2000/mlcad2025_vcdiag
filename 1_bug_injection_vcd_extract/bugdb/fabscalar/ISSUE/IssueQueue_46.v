...
reg [`SIZE_ISSUEQ-1:0] freedValid_mispre; // BUG_8: Inserted missing_assignment bug
...
assign payloadRAMDataWr3 = {inst3Source1[`SIZE_PHYSICAL_LOG:1],inst3Source1[`SIZE_PHYSICAL_LOG:1], // BUG_5: Inserted wrong_assignment bug
