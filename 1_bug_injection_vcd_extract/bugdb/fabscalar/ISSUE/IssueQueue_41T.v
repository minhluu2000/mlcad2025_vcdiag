...
assign payloadRAMwe2 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_2: Inserted logic_bug bug
...
begin: preparing_request_vector_for_FU2
	...
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
		// requestVector2[k] = (ISSUEQ_VALID[k] & ~ISSUEQ_SCHEDULED[k] & SRC0_REG_VALID[k] & SRC1_REG_VALID[k] & (ISSUEQ_FU[k] == 2'b10)) ? 1'b1:1'b0; // BUG_4: Inserted missing_assignment bug
	end
end
...
RSR2 rsr(
	...
	.reset(reset),
	.ctrlVerified_i(ctrlVerified_i),
	.ctrlMispredict_i(!ctrlMispredict_i), // BUG_3: Inserted logic_bug bug
	...
	.branchMask1_i(~BRANCH_MASK[grantedEntry1]), // BUG_1: Inserted bitwise_corruption bug
