...
assign rsr1Tag_t = {rsr0Tag, rsr0TagValid}; // BUG_1: Inserted wrong_assignment bug
...
************************************************************************************/
assign grantedValid0_t  = grantedValid0 || ~(ctrlMispredict_i && BRANCH_MASK[grantedEntry0][ctrlSMTid_i]); // BUG_2: Inserted bitwise_corruption bug
...
begin
	...
	begin
		...
		begin
			// ISSUEQ_VALID <= issueqValid_normal; // BUG_3: Inserted missing_assignment bug
		end
