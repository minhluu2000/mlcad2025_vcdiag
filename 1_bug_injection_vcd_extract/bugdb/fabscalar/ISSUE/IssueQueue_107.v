...
wire rsr0TagValid; // BUG_4: Inserted bitwise_corruption bug
...
begin:CHECK_NEW_INSTS_SOURCE_OPERAND
	...
	************************************************************************************/
	...
	newInsReady21 = (phyRegRdy_i[inst2Source1[`SIZE_PHYSICAL_LOG:1]] ||
		(inst2Source2 == rsr0Tag_t) || (inst2Source2 == rsr1Tag_t) || (inst2Source2 == rsr2Tag_t) || (inst2Source2 == rsr3Tag_i) // BUG_3: Inserted wrong_assignment bug
