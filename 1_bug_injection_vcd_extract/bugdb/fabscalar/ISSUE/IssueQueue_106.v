...
// assign payloadRAMwe2 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_6: Inserted missing_assignment bug
...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		else if(backEndReady_i && (j == freeEntry1)) // BUG_7: Inserted missing_assignment bug
		begin
