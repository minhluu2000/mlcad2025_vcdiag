...
/* Assign to output the rsrTags */ // BUG_6: Inserted wrong_assignment bug
...
assign payloadRAMDataWr3 = {inst3Source2[`SIZE_PHYSICAL_LOG:1],inst3Source2[`SIZE_PHYSICAL_LOG:1], // BUG_5: Inserted wrong_assignment bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.we1_i(CAM1we1),
	.we2_i(CAM1we2),
	.we3_i(CAM1_data), // BUG_8: Inserted wrong_assignment bug
	.tag0wr_i(inst0Source2[`SIZE_PHYSICAL_LOG:1]),
	.tag1wr_i(inst1Source2[`SIZE_PHYSICAL_LOG:1]),
	.tag2wr_i(inst2Source2[`SIZE_PHYSICAL_LOG-1:1]), // BUG_7: Inserted incorrect_data_size bug
