...
************************************************************************************/
assign payloadRAMwe0 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_12: Inserted logic_bug bug
// assign payloadRAMwe1 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_11: Inserted missing_assignment bug
assign payloadRAMwe2 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_9: Inserted bitwise_corruption bug
...
begin: PREPARE_VALID_ARRAY_MISPRED
	...
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
		if((freedValid1 && k == freedEntry0) || (freedValid0 && k == freedEntry1) || (freedValid2 && k == freedEntry2) || (freedValid3 && k == freedEntry3)) // BUG_10: Inserted wrong_assignment bug
