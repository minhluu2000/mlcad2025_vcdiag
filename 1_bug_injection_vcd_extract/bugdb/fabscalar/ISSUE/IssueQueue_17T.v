...
assign grantedValid2_t  = grantedValid3 && ~(ctrlMispredict_i && BRANCH_MASK[grantedEntry3][ctrlSMTid_i]);
  assign grantedValid3_t  = grantedValid2 && ~(ctrlMispredict_i && BRANCH_MASK[grantedEntry2][ctrlSMTid_i]);//bug issue 17
