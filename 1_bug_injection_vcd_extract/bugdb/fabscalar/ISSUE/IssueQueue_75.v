...
// assign payloadRAMwe2 = backEndReady_i && ~(ctrlVerified_i && ctrlMispredict_i); // BUG_4: Inserted missing_assignment bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.we0_i(CAM1we0),
	.we1_i(CAM1we1),
	.we2_i(CAM1we1), // BUG_2: Inserted wrong_assignment bug
	.we3_i(CAM1we3),
...
begin: PREPARE_SCHEDULE_ARRAY
	...
	begin
		...
		else // BUG_1: Inserted missing_assignment bug
