...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	.reset(reset),
	.tag0_i(rsr1Tag_t[`SIZE_PHYSICAL_LOG:1]), // BUG_9: Inserted wrong_assignment bug
...
begin: preparing_request_vector_for_FU0
	integer k; // BUG_10: Inserted missing_assignment bug
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
...
Select select0(.clk(clk),
	...
	.grantedValid_o(grantedValid1) // BUG_12: Inserted wrong_assignment bug
);
...
Select select2(.clk(clk),
	.reset(reset),
	.requestVector_i(requestVector1), // BUG_11: Inserted wrong_assignment bug
