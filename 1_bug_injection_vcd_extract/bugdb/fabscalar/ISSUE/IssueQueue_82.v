...
wire [`SIZE_ISSUEQ-1:0] src1_matchLines0; // BUG_12: Inserted bitwise_corruption bug
...
// assign payloadRAMwe2 = backEndReady_i || ~(ctrlVerified_i && ctrlMispredict_i); // BUG_11: Inserted logic_bug bug
...
begin: PREPARE_VALID_ARRAY_MISPRED
	...
	begin
		if((freedValid0 && k == freedEntry0) || (freedValid1 && k == freedEntry1) || (freedValid2 && k == freedEntry2) || (freedValid3 && k == freedEntry3))
			...
			issueqValid_normal[k] = ISSUEQ_VALID[k]; // BUG_9: Inserted wrong_assignment bug
	end
