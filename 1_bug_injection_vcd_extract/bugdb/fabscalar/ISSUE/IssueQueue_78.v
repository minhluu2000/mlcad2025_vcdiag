...
begin: UPDATE_SRC_READY_BIT
	...
	begin
		...
		begin
			// src0RegValid_t1[j]  =  newInsReady01; // BUG_5: Inserted missing_assignment bug
			src1RegValid_t1[j]  =  newInsReady02;
		end
		else if(backEndReady_i && (j == freeEntry1))
		begin
			src1RegValid_t1[j]  =  newInsReady11; // BUG_8: Inserted wrong_assignment bug
...
begin: PREPARE_VALID_ARRAY_MISPRED
	...
	for(i=0; i<`SIZE_ISSUEQ; i=i+1)
	begin
		if(ctrlVerified_i ^ ctrlMispredict_i)    /* Unnecessary logic? */ // BUG_7: Inserted logic_bug bug
		begin
