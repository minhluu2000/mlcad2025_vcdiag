...
assign payloadRAMDataWr2 = {inst2Source2[`SIZE_PHYSICAL_LOG:1],inst2Source1[`SIZE_PHYSICAL_LOG:1],
	...
	`SIZE_CTI_LOG:`INST_TYPES_LOG+`SIZE_OPCODE_I+2*`SIZE_PC+`SIZE_CTI_LOG+1],
	dispatchPacket2_i[`SIZE_OPCODE_I+2*`SIZE_PC+`SIZE_CTI_LOG:0]}; // BUG_7: Inserted bitwise_corruption bug
...
CAM_4R4W #(`SIZE_ISSUEQ,`SIZE_ISSUEQ_LOG, `SIZE_PHYSICAL_LOG) src1cam (.clk(clk),
	...
	.tag3wr_i(inst3Source1[`SIZE_PHYSICAL_LOG:1]), // BUG_6: Inserted wrong_assignment bug
...
* [i] New Entry position should not be set to 1 // BUG_5: Inserted logic_bug bug
