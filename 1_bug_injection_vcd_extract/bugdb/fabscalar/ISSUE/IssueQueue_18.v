...
begin:UPDATE_BRANCH_MASK_POSEDGE_CLK
	...
	begin
		...
		begin
			...
			else if(backEndReady_i || (l == freeEntry1)) // BUG_11: Inserted logic_bug bug
			begin
...
begin: preparing_request_vector_for_FU2
	...
	for(k=0; k<`SIZE_ISSUEQ; k=k+1)
	begin
		requestVector2[k] = (ISSUEQ_VALID[k] & ~ISSUEQ_SCHEDULED[k] & SRC0_REG_VALID[k] & SRC1_REG_VALID[k] & (ISSUEQ_FU[k] & 2'b10)) ? 1'b1:1'b0; // BUG_10: Inserted logic_bug bug
	end
end
