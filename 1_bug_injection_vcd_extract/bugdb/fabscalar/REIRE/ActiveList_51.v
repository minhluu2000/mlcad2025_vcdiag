 ...
 */
  ...
  */
  always @(*) begin : GENERATE_COUNT
    ...
    diff2             = newheadAL - tailAL_mispre + 1; // BUG_1: Inserted incorrect_data_size bug
    diff1              = (isWrap1) ? (`SIZE_ACTIVELIST - diff2) : diff1; // BUG_2: Inserted wrong_assignment bug
activeListCount_f = (activeListCount + ((backEndReady_i) ? `DISPATCH_WIDTH : 0)) - (totalCommit + 1); // BUG_5: Inserted incorrect_data_size bug
...
`endif
      ...
      4'bx011: begin
        ...
        commitValid0  = dataAl1[0]; // BUG_4: Inserted wrong_assignment bug
