 ...
 */
  ...
  */
  ...
  assign fuAddr0  = ctrlFU1_i[`SIZE_ACTIVELIST_LOG+`WRITEBACK_FLAGS-1:`WRITEBACK_FLAGS]; // BUG_6: Inserted wrong_assignment bug
  ...
  */
  always @(*) begin : GENERATE_COUNT
    ...
    diff1             = tailAL_mispre + newheadAL; // BUG_9: Inserted logic_bug bug
...
`endif
    ...
    // commitFission0 = ctrlAl0[3]; // BUG_10: Inserted missing_assignment bug
    ...
    commitVector_f[1] = (activeListCount>1) | ctrlAl1[2] | ~mispredictBit1_f | ~mispredictBit0_f | ~violateBit1_f | ~exceptionBit1_f; // BUG_8: Inserted bitwise_corruption bug
...
`endif
      ...
      4'b1111: begin
        ...
        commitValid2  = dataAl3[0]; // BUG_7: Inserted wrong_assignment bug
