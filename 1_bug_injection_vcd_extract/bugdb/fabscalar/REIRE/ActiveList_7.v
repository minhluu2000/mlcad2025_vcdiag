 ...
 */
  ...
  */
  ...
  assign fuData1  = ctrlFU1_i[`WRITEBACK_FLAGS-2:0]; // BUG_2: Inserted wrong_assignment bug
...
`endif
      ...
      4'b0111: begin
        ...
        commitPacket1 = dataAl1[`SIZE_RMT_LOG+2*`SIZE_PHYSICAL_LOG:1];
        commitStore1  = dataAl1[1+`SIZE_PC+`SIZE_RMT_LOG+2*`SIZE_PHYSICAL_LOG];
        commitLoad1 = dataAl1[2+`SIZE_PC+`SIZE_RMT_LOG+2*`SIZE_PHYSICAL_LOG] ^ 1'b1; // BUG_1: Inserted bitwise_corruption bug
        commitCti[1]  = ctrlAl1[7];
