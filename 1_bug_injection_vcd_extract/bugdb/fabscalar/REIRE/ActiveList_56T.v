...
// BUG_14: Inserted missing_assignment bug
  ...
  reg                                                    commitValid0;
  reg  [         `SIZE_RMT_LOG+2*`SIZE_PHYSICAL_LOG-1:0] commitPacket0; // BUG_15: Inserted wrong_assignment bug
  reg                                                    commitStore0;
  reg                                                    commitLoad0;
  reg                                                    commitFission0;
  ...
  reg                                                    commitStore3;
  reg                                                    commitLoad3; // BUG_11: Inserted bitwise_corruption bug
  reg                                                    commitFission3;
...
************************************************************************************/
  ...
  SRAM_4R4W #(`SIZE_ACTIVELIST, `SIZE_ACTIVELIST_LOG, `WRITEBACK_FLAGS) ctrlActiveList (
      ...
      .addr0wr_i(fuAddr0),
      .we0_i(fuEn1), // BUG_13: Inserted wrong_assignment bug
      .data0wr_i(fuData0),
      .addr1wr_i(fuAddr1),
      .we1_i(fuEn1),
      .data1wr_i(fuData1),
 ...
 */
  ...
  SRAM_4R1W #(`SIZE_ACTIVELIST, `SIZE_ACTIVELIST_LOG, 1) ldViolateVector (
      ...
      .data0wr_i(ldViolationPacket_i[1]), // BUG_12: Inserted wrong_assignment bug
      .data0_o(violateBit0),
      .data1_o(violateBit1),
      .data2_o(violateBit2),
      .data3_o(violateBit3)
