 ...
 */
  ...
  // assign tailAddr1  = tailAL+1; // BUG_8: Inserted missing_assignment bug
...
`ifdef VERIFY
    ...
    commitVerify2 = 0;
    commitVerify3 = 0;
    commitCount_f = commitCount ^ commitCount; // BUG_10: Inserted bitwise_corruption bug
`endif
   ...
   */
    ...
    if (!commitFission3) commitVector[3] = 1'b0; // BUG_6: Inserted logic_bug bug
...
`endif
      ...
      4'b0111: begin
        ...
        // commitValid2  = dataAl2[0]; // BUG_7: Inserted missing_assignment bug
...
`endif
      ...
      4'b1111: begin
        ...
        commitValid1  = dataAl2[0]; // BUG_9: Inserted wrong_assignment bug
        commitPacket2 = dataAl2[`SIZE_RMT_LOG+2*`SIZE_PHYSICAL_LOG:1];
        commitStore2  = dataAl2[1+`SIZE_PC+`SIZE_RMT_LOG+2*`SIZE_PHYSICAL_LOG];
        commitLoad2   = dataAl2[2+`SIZE_PC+`SIZE_RMT_LOG+2*`SIZE_PHYSICAL_LOG];
        commitCti[2]  = ctrlAl2[7];
