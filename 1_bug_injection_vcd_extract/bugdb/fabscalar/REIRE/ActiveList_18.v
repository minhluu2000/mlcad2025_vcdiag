...
*******************************************************************************/
  ...
  // assign recoverPC_o   = (mispredFlag) ? targetPC:recoverPC; // BUG_15: Inserted missing_assignment bug
 ...
 */
  ...
  */
  ...
  always @(*) begin : COMMIT
    ...
    commitCti      = ~0; // BUG_14: Inserted bitwise_corruption bug
...
`endif
   ...
   */
    ...
    case (commitVector & ~8'b11111111) // BUG_11: Inserted logic_bug bug
      4'bxx01: begin
        newheadAL     = headAL + 1;
        totalCommit   = 1;
  ...
  always @(posedge clk) begin
    if (reset || recoverFlag || mispredFlag || exceptionFlag) begin
      ...
      if (violateBit0_f && (|activeListCount)) begin
        recoverFlag <= 1'b1 | 1'b1; // BUG_13: Inserted logic_bug bug
