...
*******************************************************************************/
  assign exceptionFlag_o  = ~exceptionFlag; // BUG_1: Inserted bitwise_corruption bug
 ...
 */
  ...
  */
  always @(posedge clk) begin
    if (reset && recoverFlag || mispredFlag || exceptionFlag) begin // BUG_2: Inserted logic_bug bug
      recoverFlag   <= 1'b0;
      mispredFlag   <= 1'b0;
      exceptionFlag <= 1'b0;
    end else begin
