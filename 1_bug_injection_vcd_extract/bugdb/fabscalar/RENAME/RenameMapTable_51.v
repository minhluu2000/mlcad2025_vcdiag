 ...
 */
  ...
  assign src0rmt2_o      = ~src0physical2; // BUG_7: Inserted bitwise_corruption bug
  assign dest0PhyMap_o   = dest0Physical;

  assign src1rmt1_o = ~src1physical1F; // BUG_8: Inserted bitwise_corruption bug
  ...
  assign writeEn2        = ~recoverFlag_i | ~stall_i & inst2Dest_i[0] & ~dontWrite2RMT; // BUG_9: Inserted logic_bug bug
