 ...
 */
  // assign src0physical1   = (src0logical1_i[0]) ? {src0physical1_r, 1'b1} : 0; // BUG_6: Inserted missing_assignment bug
  ...
  assign src2rmt1_o      = src2physical2F1; // BUG_5: Inserted wrong_assignment bug
  assign src2rmt2_o      = src2physical2F1;
  assign dest2PhyMap_o   = dest2Physical;

  // assign src3rmt1_o      = src3physical1F2; // BUG_4: Inserted missing_assignment bug
