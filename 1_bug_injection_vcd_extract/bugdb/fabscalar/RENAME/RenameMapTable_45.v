...
*******************************************************************************/
  always @(*) begin
    case ({
      ...
      4'b1011: begin
        dest0Physical = dest0Physical_i;
        dest1Physical = dest2Physical_i; // BUG_1: Inserted wrong_assignment bug
        dest2Physical = 0;
 ...
 */
  ...
  assign writeEn2        = ~recoverFlag_i & ~stall_i & inst2Dest_i[0] | dontWrite2RMT; // BUG_2: Inserted bitwise_corruption bug
