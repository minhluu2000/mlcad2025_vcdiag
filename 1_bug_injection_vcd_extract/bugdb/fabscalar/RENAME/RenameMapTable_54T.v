...
*/
  ...
  wire [`SIZE_PHYSICAL_LOG-1:0] src1physical2_r; // BUG_10: Inserted wrong_assignment bug
  wire [`SIZE_PHYSICAL_LOG-1:0] src2physical1_r;
  wire [`SIZE_PHYSICAL_LOG-1:0] src2physical2_r; // BUG_11: Inserted wrong_assignment bug
  ...
  always @(*) begin
    case ({
      ...
      4'b0001: begin
        ...
        dest1Physical = 0;
        dest2Physical = 1; // BUG_12: Inserted wrong_assignment bug
        dest3Physical = 0;
      end
      4'b0010: begin
        dest0Physical = 0;
