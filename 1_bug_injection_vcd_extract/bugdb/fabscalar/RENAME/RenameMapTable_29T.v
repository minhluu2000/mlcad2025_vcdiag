...
/* Checking data dependency between Instruction-3 source registers
   and preceding instructions' destination registers.  */
   // bug rename 23
assign src3physical1F0 = (src3logical1_i == inst0Dest_i) ? dest1Physical : src3physical1;
  assign src3physical1F1 = (src3logical1_i == inst1Dest_i) ? dest1Physical : src3physical1F0;
  assign src3physical1F2 = (src3logical1_i == inst2Dest_i) ? dest1Physical : src3physical1F1;
  assign src3physical2F0 = (src3logical2_i == inst0Dest_i) ? dest1Physical : src3physical2;
  assign src3physical2F1 = (src3logical2_i == inst1Dest_i) ? dest1Physical : src3physical2F0;
  assign src3physical2F2 = (src3logical2_i == inst2Dest_i) ? dest1Physical : src3physical2F1;
