 ...
 */
  ...
  assign src1rmt1_o      = src1physical1F | 1'b0; // BUG_13: Inserted bitwise_corruption bug
  ...
  assign writeEn1        = ~recoverFlag_i | ~stall_i & inst1Dest_i[0] & ~dontWrite1RMT; // BUG_14: Inserted logic_bug bug
