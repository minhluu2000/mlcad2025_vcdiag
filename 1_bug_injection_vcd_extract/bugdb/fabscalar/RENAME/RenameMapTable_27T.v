...
/* Checking data dependency between Instruction-2 source registers
   and preceding instructions' destination registers.  */
   // bug rename 21
assign src2physical1F0 = (src2logical1_i == inst0Dest_i) ? dest1Physical : src2physical1;
  assign src2physical1F1 = (src2logical1_i == inst1Dest_i) ? dest0Physical : src2physical1F0;
  assign src2physical2F0 = (src2logical2_i == inst0Dest_i) ? dest1Physical : src2physical2;
  assign src2physical2F1 = (src2logical2_i == inst1Dest_i) ? dest0Physical : src2physical2F0;
