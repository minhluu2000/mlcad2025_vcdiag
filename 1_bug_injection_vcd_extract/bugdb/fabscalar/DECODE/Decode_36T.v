 ...
 */
  ...
  assign decodedPacket1_o    = decodedPacket_f[0]; // BUG_1: Inserted wrong_assignment bug
  assign decodedPacket2_o    = decodedPacket_f[1]; // BUG_3: Inserted wrong_assignment bug
  ...
  assign decodedPacket6_o    = ~decodedPacket_f[5]; // BUG_4: Inserted wrong_assignment bug
